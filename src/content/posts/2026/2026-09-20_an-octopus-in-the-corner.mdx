...
description: "Inky is the snarky octopus in the corner of this site. A small model writes his lines from tech headlines, the build bakes them into the page, and phones never see him. How he works, and how I found out he had gone quiet twice."
...
<ArticleStep id="not-a-chatbot" number="01" icon="🐙" title="He doesn't chat" />
...
<ArticleStep id="from-headlines" number="02" icon="🌊" title="Where the lines come from" />
...
<ArticleStep id="also-in-the-prompt" number="05" icon="⌨️" title="He's in the homepage terminal too" />
