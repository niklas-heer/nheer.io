...
import HubDiscovery from '../../../components/HubDiscovery.astro';
import HubOwnership from '../../../components/HubOwnership.astro';
...
<ArticleStep id="choose-a-home" number="01" icon="🧭" title="Give the work a home" />
...
Try these three examples. The destination changes with what the knowledge belongs to:
...
<ArticleStep id="start-with-folders" number="02" icon="📂" title="Start with four folders" />
...
<ArticleStep id="route-preferences" number="03" icon="⚙️" title="Load the preferences you need" />
...
<ArticleStep id="keep-the-reason" number="04" icon="📝" title="Keep the reason behind the choice" />
...
<details className="hub-copy-block">
<summary>🧪 The optional experiment: asking a model what to keep</summary>
...
<ArticleStep id="try-a-fresh-session" number="05" icon="↩️" title="Come back in a fresh session" />
...
<style>{`
  ...
  .hub-copy-block > p:last-child { margin-bottom: 0; }
`}</style>
