---
title: "Rust's compiler can yell at the agent now"
...
inky:
  ...
  - section: "what-the-commit-log-shows"
  ...
  - section: "ten-pull-requests-in-eleven-minutes"
  ...
  - section: "a-python-runtime-with-a-zig-host"
  ...
  - section: "where-rust-went-and-where-it-did-not"
...
That became [Kipferl](https://github.com/niklas-heer/kipferl), called μcharm at the time. In eight months it swapped its Python runtime once and its host language once.

<ArticleFlow
  id="kipferl-hops" title="Two Python runtimes, two hosts, eight months."
  caption="Dates are the first commits of each change in niklas-heer/kipferl. The Python-facing API and the single-file packaging stayed the same throughout."
  steps={[
    { label: '16 Dec 2025', title: 'MicroPython, hosted by Zig', detail: 'The proof of concept: MicroPython embedded in a Zig command-line tool. It replaced a Python wrapper script within half an hour.' },
