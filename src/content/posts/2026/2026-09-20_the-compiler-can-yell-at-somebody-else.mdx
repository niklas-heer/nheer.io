...
inky:
  ...
  - section: "a-todo-list-with-a-runtime-inside"
    comment: "New achievement! Interpreter Included. You reached for Python, picked Bun instead, and shipped a todo list with an entire JavaScript runtime folded into it. Reward: 59 megabytes of ambition."
